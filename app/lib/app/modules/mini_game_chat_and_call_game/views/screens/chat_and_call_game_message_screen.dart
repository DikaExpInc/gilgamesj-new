...
import 'package:app/app/modules/mini_game_chat_and_call_game/views/screens/chat_and_call_game_call_screen.dart';
            ...
            children: [
              ...
              Obx(() {
                return controller.isFinished.value
                    ? InkWell(
                        onTap: () => {
                          controller.setWidget(ChatAndCallGameCallScreen()),
