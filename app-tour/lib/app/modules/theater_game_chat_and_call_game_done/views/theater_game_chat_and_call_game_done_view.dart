...
class TheaterGameChatAndCallGameDoneView
    extends GetView<TheaterGameChatAndCallGameDoneController> {
  late double mWidth;
  late double mHeight;
              ...
              Center(
                child: DefaultTextStyle(
                  ...
                  child: AnimatedTextKit(
                    animatedTexts: [
                      TyperAnimatedText(
                          'Lekker gebruld, geef de tablet aan  ${GetStorage().read('played_name_${GetStorage().read('played_number')}')}',
