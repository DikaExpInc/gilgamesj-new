    ...
    try {
      ...
      if (socialMedia.likes.includes(req.player._id)) {
        return res.status(400).json({
          error: 1,
          message: "User already liked this Social Media",
        });
      }

      // Tambahkan ID pengguna ke daftar "likes" dan increment "like" count
      socialMedia.likes.push(req.player._id);
      socialMedia.like = socialMedia.likes.length; // Menggunakan likesCount untuk menghitung jumlah likes
