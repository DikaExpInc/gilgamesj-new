...
const GalleryVideoForm = (props) => {
  ...
  useEffect(() => {
    if (mode === EDIT) {
      ...
      // FirebaseService.getGalleryVideoDetail(id).then((querySnapshot) => {
      //   setGalleryVideoData({ ...querySnapshot.data(), id: querySnapshot.id })
      //   form.setFieldsValue({
  ...
  const onFinish = () => {
    ...
    //     setTimeout(async () => {
    //       if (mode === ADD) {
    //         const fileName = `images/galleries/videos/${Date.now()}-${
    //           imageOriginal.name
    //         }`
    ...
    //           FirebaseService.addGalleryVideo({
    //             ...values,
    //             downloadUrl,
    //             date: Date.now(),
    //           }).then((resp) => {
    ...
    //             )
    //             message.success(
    //               `Create galleryVideo with title '${values.title}'`
    //             )
    ...
    //           FirebaseService.updateGalleryVideo(galleryVideoData.id, {
    //             ...values,
